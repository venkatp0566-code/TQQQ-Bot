...
| Data | Source | Why |
|------|--------|-----|
| QQQ daily history (SMA, ATR) | YT | 6800+ days, matches Yahoo Finance exactly |
| Real-time / pre-market QQQ price | Alpaca | Accurate live quotes |
| VIX | yfinance | Only reliable free source |
| Nasdaq breadth (top 20 holdings) | YT | Same accuracy as main QQQ data |
...
- [YT](https://YT.com) — reliable free historical price data
