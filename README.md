...
License: MIT Python 3.9+ Paper Trading
...
See DISCLAIMER.md for full terms. By using this software, you agree to them.
...
Prerequisites
An Alpaca Markets account (free paper trading account is enough to start)
...
Deposit real money into your Alpaca live account
Edit config.py:
PAPER_MODE = False
Restart the bot:
sudo systemctl restart tqqq-bot
Watch the logs and Telegram alerts closely for the first few days
Cost to Run
Component	Cost
...
Total	$0–$8/month
How to Contribute
See CONTRIBUTING.md. Ideas for contributions:
...
Acknowledgements
Alpaca Markets — commission-free brokerage API
Stooq — reliable free historical price data
yfinance — VIX data access
